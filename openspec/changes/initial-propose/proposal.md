...
- **CLI Interface**: Implement a CLI using Python's standard library `argparse` to accept frequency, amplitude, line color, and optional PNG export flag.
